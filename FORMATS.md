...
| **HSBC** | HSBCnet | **BACSSTD18** (BACS + FPS) · **ISO 20022 XML** `pain.001` (all incl. SEPA) · CSV | ✅ Std 18 · ✅ ISO (UK GBP) |
| **Barclays** | Barclays.Net / iGTB iPortal | Bacs Standard 18 · ISO 20022 XML (MX / `pain.001`) · mapped CSV | ✅ Std 18 · ✅ ISO (UK GBP) · ⬜ CSV |
| **Lloyds / Bank of Scotland** | Commercial Banking Online | CSV templates (BACS single, BACS multiple, Faster Payment) · Standard 18 (bureau) · ISO 20022 XML | ✅ Std 18 · ✅ ISO (UK GBP) · ⬜ CSV |
| **NatWest / RBS / Ulster** | Bankline | Bacs Standard 18 · Bankline CSV · ISO 20022 **`pain.001.001.09`** (SWIFT MT retiring Nov 2025) | ✅ Std 18 · ✅ ISO (UK GBP) · ⬜ CSV |
| **NatWest** | Bankline Direct (corporate) | ISO 20022 `pain.001.001.09` · Standard 18 · JSON · ISO 8583 · (SWIFT MT) | ✅ Std 18 · ✅ ISO (UK GBP) |
